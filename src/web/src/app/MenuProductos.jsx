...
export default function MenuProductos() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const menuRes = await fetch(`${process.env.REACT_APP_API_URL}/api/menu/${idMenu}/productos`, {
                ...
                const productsRes = await fetch(`${process.env.REACT_APP_API_URL}/api/producto/mostrar`, {
                    headers: { Authorization: `Bearer ${token}` }
                });
    ...
    const addProductToMenu = async (idProducto) => {
        ...
        try {
            const res = await fetch(`${process.env.REACT_APP_API_URL}/api/menu/agregar/${idMenu}/producto`, {
                method: 'POST',
                headers: {
    ...
    const removeProductFromMenu = async (idProducto) => {
        ...
        try {
            const res = await fetch(`${process.env.REACT_APP_API_URL}/api/menu/eliminar/${idMenu}/producto/${idProducto}`, {
                method: 'DELETE',
                headers: { Authorization: `Bearer ${token}` }
            });
