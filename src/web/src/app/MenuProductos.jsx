...
export default function MenuProductos() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const menuRes = await fetch(`http://api-cafeteria.uidehub.tech/api/menu/${idMenu}/productos`, {
                ...
                const productsRes = await fetch('http://api-cafeteria.uidehub.tech/api/producto/mostrar', {
                    headers: { Authorization: `Bearer ${token}` }
                });
    ...
    const addProductToMenu = async (idProducto) => {
        ...
        try {
            const res = await fetch(`http://api-cafeteria.uidehub.tech/api/menu/agregar/${idMenu}/producto`, {
                method: 'POST',
                headers: {
    ...
    const removeProductFromMenu = async (idProducto) => {
        ...
        try {
            const res = await fetch(`http://api-cafeteria.uidehub.tech/api/menu/eliminar/${idMenu}/producto/${idProducto}`, {
                method: 'DELETE',
                headers: { Authorization: `Bearer ${token}` }
            });
