...
export default function Cafeteria({ onLogout }) {
    ...
    if (activeTab === 'productos') {
      const fetchProducts = async () => {
        try {
          ...
          const res = await fetch('http://api-cafeteria.uidehub.tech/api/producto/mostrar', {
  ...
  const toggleStatus = async (product) => {
    ...
    try {
      const res = await fetch(`http://api-cafeteria.uidehub.tech/api/producto/actualizar/${product.idProducto}`, {
        method: 'PUT',
        headers: { Authorization: `Bearer ${token}` },
        body: fd
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingItem
        ? `http://api-cafeteria.uidehub.tech/api/producto/actualizar/${editingItem.idProducto}`
        : 'http://api-cafeteria.uidehub.tech/api/producto/crear';
